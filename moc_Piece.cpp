...
QT_MOC_LITERAL(1, 6, 9), // "DropPiece"
...
void Piece::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->DropPiece((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (Piece::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Piece::DropPiece)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Piece::DropPiece(int _t1, int _t2)
{
